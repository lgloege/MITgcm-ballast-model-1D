...
### vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
rootdir="/rigel/ocpbgc/users/luke/MITgcm-1D_v2/source"
optfile="${rootdir}/tools/build_options/linux_ia64_ifort_habanero"
mods='/rigel/ocpbgc/users/luke/MITgcm-1D_v2/code/1d_ballast_v2'
...
${rootdir}/tools/genmake2  -mods=${mods} -optfile=${optfile} -rootdir=${rootdir}
